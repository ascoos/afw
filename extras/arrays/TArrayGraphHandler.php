...
class TArrayGraphHandler extends TArrayHandler
{
    ...
    public function createPieChart(string $filePath): void {
        $imageWidth = (int) $this->properties['width'] ?? 800;
        $imageHeight = (int) $this->properties['height'] ?? 600;
    ...
    public function createPolarAreaChart(string $filePath): void {
        $width = (int) $this->properties['width'] ?? 600;
        $height = (int) $this->properties['height'] ?? 600;
        $fontPath = $this->properties['fontPath'] ?? '../../../fonts/Noto/NotoSans-Regular.ttf';
        $backgroundColorIndex = $this->properties['backgroundColorIndex'] ?? 1;
