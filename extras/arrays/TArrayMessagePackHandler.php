 ...
 * @subpackage         	: Handles MessagePack format arrays.
 * @source             	: afw/extras/arrays/TArrayMessagePackHandler.php
 * @fileNo             	: 
 * @version            	: 24.0.5
...
/******************************************************************************
 * @startcode TArrayMessagePackHandler
 *****************************************************************************/
/**
 ...
 * 
 * [ METHODS ]
 * @method int|false toMessagePack(string $filePath)     Converts array to MessagePack format and saves to file.
 * @method void fromMessagePack(string $filePath)   Converts MessagePack format to array.
 */
 class TArrayMessagePackHandler extends TArrayHandler
 {
     /**
      ...
      * @return void
      */
     public function toMessagePack(string $filePath): int|false
     {
         /*
         <English>
         ...
         */
         return file_put_contents($filePath, $messagePack);
     }
...
/******************************************************************************
 * @endcode TArrayMessagePackHandler
 *****************************************************************************/
?>