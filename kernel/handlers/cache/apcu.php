 ...
 * @source             	: afw/kernel/handlers/cache/apcu.php
 * @fileNo             	: 
 * @version            	: 25.0.0
 * @build               : 10829
...
namespace ASCOOS\FRAMEWORK\Kernel\Cache\Apcu;
...
/******************************************************************************
 * @startcode TCacheAPCuHandler
 *****************************************************************************/
/**
 * @class   TCacheAPCuHandler
 * @extends TCacheHandler
 * 
 * @summary Handles APCu-based Cache.
 * 
 * [ METHODS ]
 * @method void __construct(int $cacheTime = 3600, array $properties = [])  Initialize the TCacheAPCuHandler class with the cache time and properties.
 ...
 * @method array getStats()                                                 Get statistics from APCu.
 ...
 */
class TCacheAPCuHandler extends TCacheHandler
{
    /**
     * Constructor.
     * 
     * @desc <English> Initialize the TCacheAPCuHandler class with the cache time and properties.
     * @desc <Greek> Αρχικοποιεί την κλάση TCacheAPCuHandler με τον χρόνο cache και τις ιδιότητες.
     * 
    ...
    {
        parent::__construct('apcu', $cacheTime, $properties);

        // Check if the APCu extension is loaded
        if (!extension_loaded('apcu')) {
            throw new Exception('The APCu PHP extension is not loaded.');
        }
    }

    /**
     * Check for cached data in APCu.
     * 
     * @desc <English> Checks for cached data in APCu.
     * @desc <Greek> Ελέγχει για δεδομένα cache στο APCu.
     * 
    ...
    /**
     * Get statistics from APCu.
     * 
     * @desc <English> Returns statistics from the APCu cache.
     * @desc <Greek> Επιστρέφει στατιστικά από την cache APCu.
     * 
     * @return array    <English> Array containing APCu statistics.
     *                  <Greek> Πίνακας που περιέχει στατιστικά του APCu.
     * 
     * @version 24.0.0
     */
     ...
     * Saves data to APCu.
     * 
     * @desc <English> Saves data to APCu.
     * @desc <Greek> Αποθηκεύει δεδομένα στο APCu.
     * 
     * @param string $cacheKey  <English> The key for the cache. 
    ...
    {
        apcu_store($cacheKey, $data, $this->cacheTime);
    }
    
    // ___________________________________________________________________________________________
    // ............... Others methods and properties of TCacheAPCuHandler Class  .................
    // ___________________________________________________________________________________________    
}
/******************************************************************************
 * @endtcode TCacheAPCuHandler
 *****************************************************************************/
